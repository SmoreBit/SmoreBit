                ...
                if (rs.next()) {
                    ...
                    if (rs.next()) {
                        ...
                        if (resultadoUsuario > 0) {
                            ...
                            // Insertar en la tabla 'sesion' con el id de usuario correspondiente
                            sta.executeUpdate("INSERT INTO sesion (usuario, contraseña, tipo, id_us) VALUES ('" + usuario + "', '" + contra + "', 1, " + idUs + ");");
