...
<%
    ...
    try {
        ...
        String sql = "SELECT id_us, tipo, contraseña FROM sesion WHERE usuario = ?";
        ...
        if (rs.next()) {
            ...
            if (storedPassword.equals(contra)) {
                ...
                int userId = rs.getInt("id_us"); // Obtén el id del usuario

                // Guarda el id del usuario y el nombre de usuario en la sesión
